...
type CPU with
    ...
    member private this.Addi(instruction: InstructionType.I) =
        ...
        this.Registers[instruction.rd] <- this.Registers[instruction.rs1] + instruction.imm

    member private this.Add(instruction: InstructionType.R) =
        Log.Info $"addi x{instruction.rd}, x{instruction.rs1}, x{instruction.rs2}"
        this.Registers[instruction.rd] <- this.Registers[instruction.rs1] + this.Registers[instruction.rs2]
