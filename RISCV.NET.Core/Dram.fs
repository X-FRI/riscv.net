...
type Dram (code : inref<uint8[]>) =
  ...
  do
    ...
    Array.blit code 0 dram 0 code.Length
    Log.Info $"A {code.Length}-byte EXECUTABLE FILE HAS BEEN LOADED"

  member this.Value = &dram

  static member public SIZE : UInt64 = 1024UL * 1024UL * 128UL

  static member public BASE : UInt64 = 0x0000_0000UL
